<template>
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" style="box-shadow: 4px 4px 20px rgb(0, 0, 0, 0.2);">
        <div class="position-fx">
            <div class="app-brand demo" style="display: flex; justify-content: space-between;">
                ...
                <a style="text-align: end;" @click="closeSideBar">
            ...
            <li class="menu-item">
                ...
                <router-link to="/sub-category/index" class="menu-link">
                    <i class="fa fa-building me-3"></i>
                    <div data-i18n="Basic" style="margin-left: 5px;">{{ $t('bar.sub-categories') }}</div>
                </router-link>
                ...
                <router-link to="/size/index" class="menu-link">
                ...
                <router-link to="/banner/index" class="menu-link">
