                    ...
                    <div class="col-xl">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">{{ this.$t('discount.title.update') }}</h5>
                            </div>
                            <div class="card-body">
                                <form @submit="discountCreate">
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-8 col-md-8 mb-3">
                                            <label class="form-label" for="basic-default-fullname">{{ this.$t('discount.parcent') }}</label>
                                            <input type="text" required class="form-control" v-model="parcent"/>
                                        </div>          
                                        <div class="col-lg-6 col-sm-8 col-md-8  mb-3">
                                            <label class="form-label" for="basic-default-fullname">{{ this.$t('discount.company') }}</label>
                                        ...
                                        <div class="col-lg-4 col-sm-8 col-md-8  mb-3">
                                            <label class="form-label" for="basic-default-fullname">{{ this.$t('discount.category') }}</label>
                                        ...
                                        <div v-if="sub" class="col-lg-4 col-sm-8 col-md-8 mb-3">
                                            <label class="form-label" for="basic-default-fullname">{{ this.$t('discount.sub_category') }}</label>
                                        ...
                                        <div v-if="produ" class="col-lg-4 col-sm-8 col-md-8  mb-3">
                                            <label class="form-label" for="basic-default-fullname">{{ this.$t('discount.product') }}</label>
    ...
    methods: {
        async getDiscounts () {
            try {
                ...
                this.parcent = this.discounts[0].parcent;
                this.start_date = this.discounts[0].start_date;
                this.end_date = this.discounts[0].end_date;
            } catch (error) {
                console.log(error);   
            }
        },
        ...
        async discountCreate (e) {
            ...
            try {
                const res = await axios.post(process.env.VUE_APP_LOCAL+'/discount/update/'+this.discount_number,
                {
                ...
                if (res.data.status == 200) {
                    this.$toast.success(this.$t('discount.updated'))
                    setTimeout(() => {
